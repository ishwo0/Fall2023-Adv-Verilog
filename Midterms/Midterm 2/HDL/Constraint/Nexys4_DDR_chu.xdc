...
#set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { compass_i2c_scl }]; #IO_L21P_T3_DQS_15 Sch=ja[3]
#set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { compass_i2c_sda }]; #IO_L18N_T2_A23_15 Sch=ja[4]
...
set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports {compass_i2c_scl}]
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports {compass_i2c_sda}]
